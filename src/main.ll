...
@str_31 = private unnamed_addr constant [14 x i8] c"hoge hoeg ffo\00", align 1
@str_32 = private unnamed_addr constant [7 x i8] c"(%s:)\0A\00", align 1
...
entry:
  ...
  store i64 ptrtoint (ptr getelementptr (%StrSlice, ptr null, i32 1) to i64), ptr %sz, align 4
  %sz2 = load i64, ptr %sz, align 4
  %calltmp = call %VecT @VecT_new(i64 %sz2, i64 1)
...
if.cond.0:                                        ; preds = %no_judge_continue-add_unsafe
  ...
  %calltmp14 = call i1 @is_space(i8 %c13)
  br i1 %calltmp14, label %if.then.0, label %if.end
...
entry:
  ...
  %sz = alloca i64, align 8
  store i64 ptrtoint (ptr getelementptr (%StrSlice, ptr null, i32 1) to i64), ptr %sz, align 4
  %sz3 = load i64, ptr %sz, align 4
  %calltmp = call %VecT @VecT_new(i64 %sz3, i64 1)
  %vec_strslice = alloca %VecT, align 8
  store %VecT %calltmp, ptr %vec_strslice, align 8
  %index = alloca i64, align 8
  store i64 0, ptr %index, align 4
  %part_len = alloca i64, align 8
  store i64 0, ptr %part_len, align 4
  %src4 = load %String, ptr %src1, align 8
  %calltmp5 = call ptr @String_as_str(%String %src4)
  %src_str = alloca ptr, align 8
  store ptr %calltmp5, ptr %src_str, align 8
  %src_str6 = load ptr, ptr %src_str, align 8
  %start = alloca ptr, align 8
  store ptr %src_str6, ptr %start, align 8
  %src7 = load %String, ptr %src1, align 8
  %calltmp8 = call %Iterator @String_iter(%String %src7)
  %it = alloca %Iterator, align 8
...
continue-add_unsafe:                              ; preds = %if.end, %if.end19, %loop_start-add_unsafe
  %calltmp9 = call %Option @iter_peek(ptr %it)
  %calltmp10 = call i1 @is_some(%Option %calltmp9)
  br i1 %calltmp10, label %no_judge_continue-add_unsafe, label %break-add_unsafe

no_judge_continue-add_unsafe:                     ; preds = %continue-add_unsafe
  %calltmp11 = call %Option @iter_next(ptr %it)
  %calltmp12 = call ptr @unwrap(%Option %calltmp11)
  %deref = load i8, ptr %calltmp12, align 1
  %c = alloca i8, align 1
  store i8 %deref, ptr %c, align 1
  %index13 = load i64, ptr %index, align 4
  %add = add i64 %index13, 1
  store i64 %add, ptr %index, align 4
  br label %if.cond.0

break-add_unsafe:                                 ; preds = %continue-add_unsafe
  br label %if.cond.028

if.cond.0:                                        ; preds = %no_judge_continue-add_unsafe
  %c14 = load i8, ptr %c, align 1
  %key15 = load i8, ptr %key2, align 1
  %eq = icmp eq i8 %c14, %key15
  br i1 %eq, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  br label %if.cond.016

if.end:                                           ; preds = %if.end19, %if.cond.0
  %part_len26 = load i64, ptr %part_len, align 4
  %add27 = add i64 %part_len26, 1
  store i64 %add27, ptr %part_len, align 4
  br label %continue-add_unsafe

if.cond.016:                                      ; preds = %if.then.0
  %part_len18 = load i64, ptr %part_len, align 4
  %sgt = icmp sgt i64 %part_len18, 0
  br i1 %sgt, label %if.then.017, label %if.end19

if.then.017:                                      ; preds = %if.cond.016
  %start20 = load ptr, ptr %start, align 8
  %part_len21 = load i64, ptr %part_len, align 4
  %calltmp22 = call %StrSlice @StrSlice_new(ptr %start20, i64 %part_len21)
  %temp = alloca %StrSlice, align 8
  store %StrSlice %calltmp22, ptr %temp, align 8
  %calltmp23 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp)
  br label %if.end19

if.end19:                                         ; preds = %if.then.017, %if.cond.016
  store i64 0, ptr %part_len, align 4
  %src_str24 = load ptr, ptr %src_str, align 8
  %index25 = load i64, ptr %index, align 4
  %ptr_add = getelementptr i8, ptr %src_str24, i64 %index25
  store ptr %ptr_add, ptr %start, align 8
  br label %continue-add_unsafe
  br label %if.end

if.cond.028:                                      ; preds = %break-add_unsafe
  %part_len30 = load i64, ptr %part_len, align 4
  %sgt31 = icmp sgt i64 %part_len30, 0
  br i1 %sgt31, label %if.then.029, label %if.end32

if.then.029:                                      ; preds = %if.cond.028
  %start33 = load ptr, ptr %start, align 8
  %part_len34 = load i64, ptr %part_len, align 4
  %calltmp35 = call %StrSlice @StrSlice_new(ptr %start33, i64 %part_len34)
  %temp36 = alloca %StrSlice, align 8
  store %StrSlice %calltmp35, ptr %temp36, align 8
  %calltmp37 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp36)
  br label %if.end32

if.end32:                                         ; preds = %if.then.029, %if.cond.028
  %vec_strslice38 = load %VecT, ptr %vec_strslice, align 8
  ret %VecT %vec_strslice38
}
...
entry:
  ...
  store ptr null, ptr %a, align 8
  %sz = alloca i64, align 8
  store i64 ptrtoint (ptr getelementptr (%String, ptr null, i32 1) to i64), ptr %sz, align 4
  %sz2 = load i64, ptr %sz, align 4
...
entry:
  ...
  %calltmp3 = call %String @String_from(ptr @str_31)
  %input = alloca %String, align 8
  store %String %calltmp3, ptr %input, align 8
...
no_judge_continue-loop:                           ; preds = %continue-loop
  ...
  %calltmp16 = call i32 (ptr, ...) @printf(ptr @str_32, ptr %calltmp15)
