...
@str_30 = private unnamed_addr constant [26 x i8] c"panic: cloning deleted Rc\00", align 1
@println_fmt_31 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_32 = private unnamed_addr constant [26 x i8] c"panic: cloning deleted Rc\00", align 1
@println_fmt_33 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_34 = private unnamed_addr constant [33 x i8] c"panic: this Rc has no strong ref\00", align 1
@println_fmt_35 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_36 = private unnamed_addr constant [72 x i8] c"warning: this Rc is not weak. instead of using Rc_upgrade, use Rc_clone\00", align 1
@println_fmt_37 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_38 = private unnamed_addr constant [32 x i8] c"panic: this Rc is already freed\00", align 1
@println_fmt_39 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_40 = private unnamed_addr constant [24 x i8] c"panic: open invalid Box\00", align 1
@println_fmt_41 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_42 = private unnamed_addr constant [24 x i8] c"panic: free invalid Box\00", align 1
@println_fmt_43 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_44 = private unnamed_addr constant [24 x i8] c"panic: move invalid Box\00", align 1
@println_fmt_45 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@stdin = external externally_initialized global ptr
@str_46 = private unnamed_addr constant [8 x i8] c"IOError\00", align 1
@println_fmt_47 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@str_48 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@str_49 = private unnamed_addr constant [5 x i8] c"%lld\00", align 1
@println_fmt_50 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
...
if.end:                                           ; preds = %if.cond.0
  ...
  store i64 %calltmp9, ptr %n, align 8
...
entry:
  ...
  store i64 %elem_size, ptr %elem_size4, align 8
  ...
  %elem_size15 = load i64, ptr %elem_size4, align 8
  %iter16 = load %Iterator, ptr %iter, align 8
  %access17 = getelementptr inbounds nuw %Iterator, ptr %iter, i32 0, i32 3
  %getmembervalue18 = load i64, ptr %access17, align 8
  store i64 %elem_size15, ptr %access17, align 8
...
entry:
  ...
  store i64 %e_size, ptr %e_size1, align 8
  %capa2 = alloca i64, align 8
  store i64 %capa, ptr %capa2, align 8
  ...
  %e_size3 = load i64, ptr %e_size1, align 8
  %capa4 = load i64, ptr %capa2, align 8
...
capaover:                                         ; preds = %pending_true
  ...
  %getmembervalue15 = load i64, ptr %access14, align 8
  ...
  %getmembervalue21 = load i64, ptr %access20, align 8
  ...
  store i64 %mul23, ptr %access25, align 8
  br label %push
...
push:                                             ; preds = %capaover, %pending_false
  ...
  %getmembervalue39 = load i64, ptr %access38, align 8
  ...
  %getmembervalue42 = load i64, ptr %access41, align 8
  ...
  store i64 %add43, ptr %access45, align 8
...
entry:
  ...
  store i64 %e_size, ptr %e_size2, align 8
  ...
  %vp = alloca ptr, align 8
  store ptr %v, ptr %vp, align 8
  %e_size4 = load i64, ptr %e_size2, align 8
  %size5 = load i64, ptr %size3, align 8
  ...
  %e_size8 = load i64, ptr %e_size2, align 8
  %size9 = load i64, ptr %size3, align 8
...
continue-capaover:                                ; preds = %no_judge_continue-capaover, %loop_start-capaover
  ...
  %getmembervalue13 = load i64, ptr %access12, align 8
  %newlen14 = load i64, ptr %newlen, align 8
...
no_judge_continue-capaover:                       ; preds = %continue-capaover
  ...
  %newcap28 = load i64, ptr %newcap, align 8
  %"&self29" = load ptr, ptr %"&self1", align 8
  %access30 = getelementptr inbounds nuw %VecT, ptr %"&self29", i32 0, i32 3
  %getmembervalue31 = load i64, ptr %access30, align 8
  store i64 %newcap28, ptr %access30, align 8
...
break-capaover:                                   ; preds = %no_judge_continue-capaover, %continue-capaover
  ...
  %newlen52 = load i64, ptr %newlen, align 8
  %"&self53" = load ptr, ptr %"&self1", align 8
  %access54 = getelementptr inbounds nuw %VecT, ptr %"&self53", i32 0, i32 2
  %getmembervalue55 = load i64, ptr %access54, align 8
  store i64 %newlen52, ptr %access54, align 8
...
entry:
  ...
  store %VecT %vec, ptr %vec1, align 8
  %ret_val = alloca %Iterator, align 8
  %vec2 = load %VecT, ptr %vec1, align 8
...
entry:
  ...
  store i64 0, ptr %access6, align 8
  %capa7 = load i64, ptr %capa1, align 8
  %vp8 = load ptr, ptr %vp, align 8
  %access9 = getelementptr inbounds nuw %String, ptr %vp8, i32 0, i32 2
  store i64 %capa7, ptr %access9, align 8
...
entry:
  ...
  store i64 %calltmp, ptr %c_len, align 8
  %c3 = load ptr, ptr %c1, align 8
  %c_len4 = load i64, ptr %c_len, align 8
...
entry:
  ...
  %c_len = alloca i64, align 8
  store i64 %calltmp, ptr %c_len, align 8
  %c_len3 = load i64, ptr %c_len, align 8
  ...
  %c_len15 = load i64, ptr %c_len, align 8
  ...
  %deref21 = load i64, ptr %access20, align 8
...
entry:
  ...
  %vp = alloca ptr, align 8
  store ptr %v, ptr %vp, align 8
  %len3 = load i64, ptr %len2, align 8
  %c_len = alloca i64, align 8
  store i64 %len3, ptr %c_len, align 8
  %c_len4 = load i64, ptr %c_len, align 8
  ...
  %c_len16 = load i64, ptr %c_len, align 8
  ...
  %deref22 = load i64, ptr %access21, align 8
...
continue-capaover:                                ; preds = %no_judge_continue-capaover, %loop_start-capaover
  ...
  %getmembervalue9 = load i64, ptr %access8, align 8
  %needed10 = load i64, ptr %needed, align 8
...
no_judge_continue-capaover:                       ; preds = %continue-capaover
  %needed12 = load i64, ptr %needed, align 8
  ...
  %getmembervalue15 = load ptr, ptr %access14, align 8
  %newcap16 = load i64, ptr %newcap, align 8
  ...
  %newcap21 = load i64, ptr %newcap, align 8
  %"&self22" = load ptr, ptr %"&self1", align 8
  %access23 = getelementptr inbounds nuw %String, ptr %"&self22", i32 0, i32 2
  %getmembervalue24 = load i64, ptr %access23, align 8
  store i64 %newcap21, ptr %access23, align 8
  br label %break-capaover
  br label %continue-capaover
...
break-capaover:                                   ; preds = %no_judge_continue-capaover, %continue-capaover
  ...
  %getmembervalue30 = load i64, ptr %access29, align 8
  ...
  %deref45 = load i64, ptr %access44, align 8
...
entry:
  ...
  %getmembervalue5 = load i64, ptr %access4, align 8
  store i64 %getmembervalue, ptr %access4, align 8
  ...
  %getmembervalue11 = load i64, ptr %access10, align 8
  store i64 %getmembervalue8, ptr %access10, align 8
  %string12 = load %String, ptr %string1, align 8
  %access13 = getelementptr inbounds nuw %String, ptr %string1, i32 0, i32 2
  %getmembervalue14 = load i64, ptr %access13, align 8
...
no_judge_continue-start:                          ; preds = %continue-start
  ...
  %start3 = load i64, ptr %start, align 8
...
if.then.0:                                        ; preds = %if.cond.0
  %start5 = load i64, ptr %start, align 8
...
no_judge_continue-end:                            ; preds = %continue-end
  ...
  %start12 = load i64, ptr %start, align 8
...
break-end:                                        ; preds = %if.else20, %continue-end
  ...
  %start27 = load i64, ptr %start, align 8
  %ptr_add28 = getelementptr i8, ptr %str26, i64 %start27
  %end29 = load i64, ptr %end, align 8
...
if.then.019:                                      ; preds = %if.cond.018
  %end23 = load i64, ptr %end, align 8
  %sub24 = sub i64 %end23, 1
  store i64 %sub24, ptr %end, align 8
  br label %if.end25
...
entry:
  ...
  %calltmp6 = call %Iterator @iter(ptr %calltmp, ptr %ptr_add, i64 1)
...
entry:
  ...
  store %StrSlice %calltmp, ptr %str, align 8
  %str3 = load %StrSlice, ptr %str, align 8
...
entry:
  ...
  store %String %src, ptr %src1, align 8
  %ret_val = alloca %VecT, align 8
  %calltmp = call %VecT @VecT_new(i64 ptrtoint (ptr getelementptr (%StrSlice, ptr null, i32 1) to i64), i64 1)
  %vec_strslice = alloca %VecT, align 8
  store %VecT %calltmp, ptr %vec_strslice, align 8
  %index = alloca i64, align 8
  store i64 0, ptr %index, align 8
  %part_len = alloca i64, align 8
  store i64 0, ptr %part_len, align 8
  %src2 = load %String, ptr %src1, align 8
  %calltmp3 = call ptr @String_as_str(%String %src2)
  %src_str = alloca ptr, align 8
  store ptr %calltmp3, ptr %src_str, align 8
  %src_str4 = load ptr, ptr %src_str, align 8
  %start = alloca ptr, align 8
  store ptr %src_str4, ptr %start, align 8
  %src5 = load %String, ptr %src1, align 8
  %calltmp6 = call %Iterator @String_iter(%String %src5)
  %it = alloca %Iterator, align 8
  store %Iterator %calltmp6, ptr %it, align 8
...
no_judge_continue-add_unsafe:                     ; preds = %continue-add_unsafe
  ...
  %index11 = load i64, ptr %index, align 8
  %add = add i64 %index11, 1
...
if.end:                                           ; preds = %if.end17, %if.cond.0
  %part_len24 = load i64, ptr %part_len, align 8
  %add25 = add i64 %part_len24, 1
  store i64 %add25, ptr %part_len, align 8
  br label %continue-add_unsafe

if.cond.014:                                      ; preds = %if.then.0
  %part_len16 = load i64, ptr %part_len, align 8
  %sgt = icmp sgt i64 %part_len16, 0
  br i1 %sgt, label %if.then.015, label %if.end17

if.then.015:                                      ; preds = %if.cond.014
  %start18 = load ptr, ptr %start, align 8
  %part_len19 = load i64, ptr %part_len, align 8
  %calltmp20 = call %StrSlice @StrSlice_new(ptr %start18, i64 %part_len19)
  %temp = alloca %StrSlice, align 8
  store %StrSlice %calltmp20, ptr %temp, align 8
  %calltmp21 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp)
  br label %if.end17

if.end17:                                         ; preds = %if.then.015, %if.cond.014
  store i64 0, ptr %part_len, align 8
  %src_str22 = load ptr, ptr %src_str, align 8
  %index23 = load i64, ptr %index, align 8
  %ptr_add = getelementptr i8, ptr %src_str22, i64 %index23
  store ptr %ptr_add, ptr %start, align 8
  br label %continue-add_unsafe
  br label %if.end

if.cond.026:                                      ; preds = %break-add_unsafe
  %part_len28 = load i64, ptr %part_len, align 8
  %sgt29 = icmp sgt i64 %part_len28, 0
  br i1 %sgt29, label %if.then.027, label %if.end30

if.then.027:                                      ; preds = %if.cond.026
  %start31 = load ptr, ptr %start, align 8
  %part_len32 = load i64, ptr %part_len, align 8
  %calltmp33 = call %StrSlice @StrSlice_new(ptr %start31, i64 %part_len32)
  %temp34 = alloca %StrSlice, align 8
  store %StrSlice %calltmp33, ptr %temp34, align 8
  %calltmp35 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp34)
  br label %if.end30

if.end30:                                         ; preds = %if.then.027, %if.cond.026
  %vec_strslice36 = load %VecT, ptr %vec_strslice, align 8
...
entry:
  ...
  %part_len = alloca i64, align 8
  store i64 0, ptr %part_len, align 8
  %src3 = load %String, ptr %src1, align 8
  %calltmp4 = call ptr @String_as_str(%String %src3)
  %src_str = alloca ptr, align 8
  store ptr %calltmp4, ptr %src_str, align 8
  %src_str5 = load ptr, ptr %src_str, align 8
  %start = alloca ptr, align 8
  store ptr %src_str5, ptr %start, align 8
  %src6 = load %String, ptr %src1, align 8
...
if.end:                                           ; preds = %if.end18, %if.cond.0
  %part_len25 = load i64, ptr %part_len, align 8
  %add26 = add i64 %part_len25, 1
  store i64 %add26, ptr %part_len, align 8
  br label %continue-add_unsafe

if.cond.015:                                      ; preds = %if.then.0
  %part_len17 = load i64, ptr %part_len, align 8
  %sgt = icmp sgt i64 %part_len17, 0
  br i1 %sgt, label %if.then.016, label %if.end18

if.then.016:                                      ; preds = %if.cond.015
  %start19 = load ptr, ptr %start, align 8
  %part_len20 = load i64, ptr %part_len, align 8
  %calltmp21 = call %StrSlice @StrSlice_new(ptr %start19, i64 %part_len20)
  %temp = alloca %StrSlice, align 8
  store %StrSlice %calltmp21, ptr %temp, align 8
  %calltmp22 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp)
  br label %if.end18

if.end18:                                         ; preds = %if.then.016, %if.cond.015
  store i64 0, ptr %part_len, align 8
  %src_str23 = load ptr, ptr %src_str, align 8
  %index24 = load i64, ptr %index, align 8
  %ptr_add = getelementptr i8, ptr %src_str23, i64 %index24
  store ptr %ptr_add, ptr %start, align 8
  br label %continue-add_unsafe
  br label %if.end

if.cond.027:                                      ; preds = %break-add_unsafe
  %part_len29 = load i64, ptr %part_len, align 8
  %sgt30 = icmp sgt i64 %part_len29, 0
  br i1 %sgt30, label %if.then.028, label %if.end31

if.then.028:                                      ; preds = %if.cond.027
  %start32 = load ptr, ptr %start, align 8
  %part_len33 = load i64, ptr %part_len, align 8
  %calltmp34 = call %StrSlice @StrSlice_new(ptr %start32, i64 %part_len33)
  %temp35 = alloca %StrSlice, align 8
  store %StrSlice %calltmp34, ptr %temp35, align 8
  %calltmp36 = call ptr @VecT_push(ptr %vec_strslice, ptr %temp35)
  br label %if.end31

if.end31:                                         ; preds = %if.then.028, %if.cond.027
  %vec_strslice37 = load %VecT, ptr %vec_strslice, align 8
...
entry:
  ...
  store i64 ptrtoint (ptr getelementptr (%String, ptr null, i32 1) to i64), ptr %sz, align 8
...
no_judge_continue-loop:                           ; preds = %continue-loop
  ...
  %i8 = load i64, ptr %i, align 8
  %idx_ptr = getelementptr %String, ptr %a7, i64 %i8
  %"idx[]_load" = load %String, ptr %idx_ptr, align 8
  store %String %calltmp6, ptr %idx_ptr, align 8
...
entry:
  ...
  store i64 %left, ptr %left2, align 8
  %right3 = alloca i64, align 8
  store i64 %right, ptr %right3, align 8
  %ret_val = alloca i64, align 8
  %arr4 = load ptr, ptr %arr1, align 8
  %right5 = load i64, ptr %right3, align 8
  ...
  %left6 = load i64, ptr %left2, align 8
  %sub = sub i64 %left6, 1
  %i = alloca i64, align 8
  store i64 %sub, ptr %i, align 8
  %left7 = load i64, ptr %left2, align 8
  %j = alloca i64, align 8
  store i64 %left7, ptr %j, align 8
  br label %loopstart

loopstart:                                        ; preds = %NoSwap, %entry
  %j8 = load i64, ptr %j, align 8
  %right9 = load i64, ptr %right3, align 8
...
InLoop:                                           ; preds = %pending_true
  ...
  %"idx[]_load13" = load i64, ptr %idx_ptr12, align 8
  %pivot14 = load i64, ptr %pivot, align 8
...
Break:                                            ; preds = %pending_false
  ...
  %right31 = load i64, ptr %right3, align 8
...
break-loop:                                       ; preds = %continue-loop
  ...
  %right29 = load i64, ptr %right3, align 8
...
entry:
  ...
  %right3 = alloca i64, align 8
  store i64 %right, ptr %right3, align 8
  %left4 = load i64, ptr %left2, align 8
  %right5 = load i64, ptr %right3, align 8
...
no_judge_continue-r:                              ; preds = %continue-r
  ...
  %n = alloca i64, align 8
  store i64 %calltmp25, ptr %n, align 8
...
entry:
  ...
  store i64 %val_size, ptr %val_size1, align 8
  %capa2 = alloca i64, align 8
  store i64 %capa, ptr %capa2, align 8
  ...
  %getmembervalue7 = load i64, ptr %access6, align 8
  store i64 %capa4, ptr %access6, align 8
  %val_size8 = load i64, ptr %val_size1, align 8
  %keymap9 = load %KeyMap, ptr %keymap, align 8
  %access10 = getelementptr inbounds nuw %KeyMap, ptr %keymap, i32 0, i32 3
  %getmembervalue11 = load i64, ptr %access10, align 8
  store i64 %val_size8, ptr %access10, align 8
  %sz = alloca i64, align 8
  store i64 ptrtoint (ptr getelementptr (%Entry, ptr null, i32 1) to i64), ptr %sz, align 8
  %sz12 = load i64, ptr %sz, align 8
  %capa13 = load i64, ptr %capa2, align 8
...
continue-check_capa:                              ; preds = %break-loop, %loop_start-check_capa
  %newsize5 = load i64, ptr %newsize, align 8
...
no_judge_continue-check_capa:                     ; preds = %continue-check_capa
  %newsize9 = load i64, ptr %newsize, align 8
  ...
  %newcap13 = load i64, ptr %newcap, align 8
  %sz14 = load i64, ptr %sz, align 8
...
break-check_capa:                                 ; preds = %break-loop, %continue-check_capa
  ...
  %getmembervalue28 = load i64, ptr %access27, align 8
  %i = alloca i64, align 8
  store i64 %getmembervalue28, ptr %i, align 8
...
break-loop:                                       ; preds = %continue-loop
  %newcap22 = load i64, ptr %newcap, align 8
  %m23 = load ptr, ptr %m1, align 8
  %access24 = getelementptr inbounds nuw %KeyMap, ptr %m23, i32 0, i32 2
  %getmembervalue25 = load i64, ptr %access24, align 8
  store i64 %newcap22, ptr %access24, align 8
...
break-loop32:                                     ; preds = %and.merge
  ...
  %getmembervalue69 = load i64, ptr %access68, align 8
  ...
  %getmembervalue74 = load i64, ptr %access73, align 8
  ...
  %getmembervalue86 = load i64, ptr %access85, align 8
  ...
  %getmembervalue90 = load i64, ptr %access89, align 8
  store i64 %add87, ptr %access89, align 8
  ret void
...
entry:
  ...
  %getmembervalue = load ptr, ptr %access, align 8
  %index5 = load i64, ptr %index2, align 8
...
entry:
  ...
  %index = alloca i64, align 8
  store i64 %calltmp, ptr %index, align 8
  br label %loop_start-loop
...
continue-check_capa:                              ; preds = %break-loop30, %loop_start-check_capa
  %newsize12 = load i64, ptr %newsize, align 8
  %m13 = load ptr, ptr %m1, align 8
...
no_judge_continue-check_capa:                     ; preds = %continue-check_capa
  %newsize17 = load i64, ptr %newsize, align 8
...
break-check_capa:                                 ; preds = %break-loop30, %continue-check_capa
  ...
  %getmembervalue41 = load i64, ptr %access40, align 8
  %i = alloca i64, align 8
  store i64 %getmembervalue41, ptr %i, align 8
...
break-loop30:                                     ; preds = %continue-loop28
  %newcap35 = load i64, ptr %newcap, align 8
  %m36 = load ptr, ptr %m1, align 8
  %access37 = getelementptr inbounds nuw %KeyMap, ptr %m36, i32 0, i32 2
  %getmembervalue38 = load i64, ptr %access37, align 8
  store i64 %newcap35, ptr %access37, align 8
  br label %break-check_capa
  br label %continue-check_capa
...
break-loop45:                                     ; preds = %and.merge
  ...
  %getmembervalue82 = load i64, ptr %access81, align 8
  ...
  %getmembervalue87 = load i64, ptr %access86, align 8
  ...
  %getmembervalue99 = load i64, ptr %access98, align 8
  ...
  %getmembervalue103 = load i64, ptr %access102, align 8
  store i64 %add100, ptr %access102, align 8
  ret i32 0
...
define %_RcBox @_RcBox_new(i64 %type_size, ptr %data) {
entry:
  %type_size1 = alloca i64, align 8
  store i64 %type_size, ptr %type_size1, align 8
  %data2 = alloca ptr, align 8
  store ptr %data, ptr %data2, align 8
  %ret_val = alloca %_RcBox, align 8
  %rc_box = alloca %_RcBox, align 8
  store %_RcBox zeroinitializer, ptr %rc_box, align 8
  %type_size3 = load i64, ptr %type_size1, align 8
  %malloc_call = call ptr @malloc(i64 %type_size3)
  %new_data = alloca ptr, align 8
  store ptr %malloc_call, ptr %new_data, align 8
  %new_data4 = load ptr, ptr %new_data, align 8
  %data5 = load ptr, ptr %data2, align 8
  %type_size6 = load i64, ptr %type_size1, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %new_data4, ptr align 1 %data5, i64 %type_size6, i1 false)
  %new_data7 = load ptr, ptr %new_data, align 8
  %rc_box8 = load %_RcBox, ptr %rc_box, align 8
  %access = getelementptr inbounds nuw %_RcBox, ptr %rc_box, i32 0, i32 0
  %getmembervalue = load ptr, ptr %access, align 8
  store ptr %new_data7, ptr %access, align 8
  %rc_box9 = load %_RcBox, ptr %rc_box, align 8
  %access10 = getelementptr inbounds nuw %_RcBox, ptr %rc_box, i32 0, i32 1
  %getmembervalue11 = load i64, ptr %access10, align 8
  store i64 1, ptr %access10, align 8
  %rc_box12 = load %_RcBox, ptr %rc_box, align 8
  %access13 = getelementptr inbounds nuw %_RcBox, ptr %rc_box, i32 0, i32 2
  %getmembervalue14 = load i64, ptr %access13, align 8
  store i64 0, ptr %access13, align 8
  %rc_box15 = load %_RcBox, ptr %rc_box, align 8
  ret %_RcBox %rc_box15
}

define %Rc @Rc_new(i64 %type_size, ptr %data) {
entry:
  %type_size1 = alloca i64, align 8
  store i64 %type_size, ptr %type_size1, align 8
  %data2 = alloca ptr, align 8
  store ptr %data, ptr %data2, align 8
  %ret_val = alloca %Rc, align 8
  %new_rc = alloca %Rc, align 8
  store %Rc zeroinitializer, ptr %new_rc, align 8
  %new_rc3 = load %Rc, ptr %new_rc, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %new_rc, i32 0, i32 1
  %getmembervalue = load i1, ptr %access, align 1
  store i1 false, ptr %access, align 1
  %new_rc4 = load %Rc, ptr %new_rc, align 8
  %access5 = getelementptr inbounds nuw %Rc, ptr %new_rc, i32 0, i32 2
  %getmembervalue6 = load i1, ptr %access5, align 1
  store i1 false, ptr %access5, align 1
  %malloc_call = call ptr @malloc(i64 ptrtoint (ptr getelementptr (%_RcBox, ptr null, i32 1) to i64))
  %rc_box_ptr = alloca ptr, align 8
  store ptr %malloc_call, ptr %rc_box_ptr, align 8
  %type_size7 = load i64, ptr %type_size1, align 8
  %data8 = load ptr, ptr %data2, align 8
  %calltmp = call %_RcBox @_RcBox_new(i64 %type_size7, ptr %data8)
  %rc_box_ptr9 = load ptr, ptr %rc_box_ptr, align 8
  store %_RcBox %calltmp, ptr %rc_box_ptr9, align 8
  %rc_box_ptr10 = load ptr, ptr %rc_box_ptr, align 8
  %new_rc11 = load %Rc, ptr %new_rc, align 8
  %access12 = getelementptr inbounds nuw %Rc, ptr %new_rc, i32 0, i32 0
  %getmembervalue13 = load ptr, ptr %access12, align 8
  store ptr %rc_box_ptr10, ptr %access12, align 8
  %new_rc14 = load %Rc, ptr %new_rc, align 8
  ret %Rc %new_rc14
}

define void @_RcBox_add_strong_count(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %_RcBox, ptr %self2, i32 0, i32 1
  %getmembervalue = load i64, ptr %access, align 8
  %add = add i64 %getmembervalue, 1
  %self3 = load ptr, ptr %self1, align 8
  %access4 = getelementptr inbounds nuw %_RcBox, ptr %self3, i32 0, i32 1
  %getmembervalue5 = load i64, ptr %access4, align 8
  store i64 %add, ptr %access4, align 8
  ret void
}

define void @_RcBox_sub_strong_count(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %self2 = load ptr, ptr %self1, align 8
  ...
  %access4 = getelementptr inbounds nuw %_RcBox, ptr %self3, i32 0, i32 1
  %getmembervalue5 = load i64, ptr %access4, align 8
  store i64 %sub, ptr %access4, align 8
  br label %if.cond.0

if.cond.0:                                        ; preds = %entry
  %self6 = load ptr, ptr %self1, align 8
  %access7 = getelementptr inbounds nuw %_RcBox, ptr %self6, i32 0, i32 1
  %getmembervalue8 = load i64, ptr %access7, align 8
  %sle = icmp sle i64 %getmembervalue8, 0
  br i1 %sle, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %self9 = load ptr, ptr %self1, align 8
  %access10 = getelementptr inbounds nuw %_RcBox, ptr %self9, i32 0, i32 0
  %getmembervalue11 = load ptr, ptr %access10, align 8
  call void @free(ptr %getmembervalue11)
  br label %if.end

if.end:                                           ; preds = %if.then.0, %if.cond.0
  ret void
}

define void @_RcBox_add_weak_count(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %_RcBox, ptr %self2, i32 0, i32 2
  %getmembervalue = load i64, ptr %access, align 8
  %add = add i64 %getmembervalue, 1
  %self3 = load ptr, ptr %self1, align 8
  %access4 = getelementptr inbounds nuw %_RcBox, ptr %self3, i32 0, i32 2
  %getmembervalue5 = load i64, ptr %access4, align 8
  store i64 %add, ptr %access4, align 8
  ret void
}

define void @_RcBox_sub_weak_count(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %self2 = load ptr, ptr %self1, align 8
...
if.cond.0:                                        ; preds = %entry
  ...
  %getmembervalue8 = load i64, ptr %access7, align 8
  %sle = icmp sle i64 %getmembervalue8, 0
  br i1 %sle, label %and.rhs, label %and.false

if.then.0:                                        ; preds = %and.merge
  %self13 = load ptr, ptr %self1, align 8
  call void @free(ptr %self13)
  br label %if.end

and.rhs:                                          ; preds = %if.cond.0
  %self9 = load ptr, ptr %self1, align 8
  %access10 = getelementptr inbounds nuw %_RcBox, ptr %self9, i32 0, i32 2
  %getmembervalue11 = load i64, ptr %access10, align 8
  %sle12 = icmp sle i64 %getmembervalue11, 0
  br label %and.merge

and.false:                                        ; preds = %if.cond.0
  br label %and.merge

and.merge:                                        ; preds = %and.false, %and.rhs
  %and.result = phi i1 [ %sle12, %and.rhs ], [ false, %and.false ]
  br i1 %and.result, label %if.then.0, label %if.end

if.end:                                           ; preds = %if.then.0, %and.merge
  ret void
}

define i64 @Rc_strong_count(%Rc %self) {
entry:
  %self1 = alloca %Rc, align 8
  store %Rc %self, ptr %self1, align 8
  %ret_val = alloca i64, align 8
  %self2 = load %Rc, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %self1, i32 0, i32 0
  %getmembervalue = load ptr, ptr %access, align 8
  %access3 = getelementptr inbounds nuw %_RcBox, ptr %getmembervalue, i32 0, i32 1
  %getmembervalue4 = load i64, ptr %access3, align 8
  ret i64 %getmembervalue4
}

define i64 @Rc_weak_count(%Rc %self) {
entry:
  %self1 = alloca %Rc, align 8
  store %Rc %self, ptr %self1, align 8
  %ret_val = alloca i64, align 8
  ...
  %access = getelementptr inbounds nuw %Rc, ptr %self1, i32 0, i32 0
  %getmembervalue = load ptr, ptr %access, align 8
  %access3 = getelementptr inbounds nuw %_RcBox, ptr %getmembervalue, i32 0, i32 2
  %getmembervalue4 = load i64, ptr %access3, align 8
  ret i64 %getmembervalue4
}

define %Rc @Rc_clone(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %ret_val = alloca %Rc, align 8
...
if.cond.0:                                        ; preds = %entry
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %self2, i32 0, i32 2
  %getmembervalue = load i1, ptr %access, align 1
  br i1 %getmembervalue, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_31, ptr @str_30)
  call void @llvm.trap()
  unreachable
  br label %if.end
...
if.cond.03:                                       ; preds = %if.end
  %self5 = load ptr, ptr %self1, align 8
  %access6 = getelementptr inbounds nuw %Rc, ptr %self5, i32 0, i32 1
  %getmembervalue7 = load i1, ptr %access6, align 1
  br i1 %getmembervalue7, label %if.then.04, label %if.else

if.then.04:                                       ; preds = %if.cond.03
  %self8 = load ptr, ptr %self1, align 8
  %access9 = getelementptr inbounds nuw %Rc, ptr %self8, i32 0, i32 0
  %getmembervalue10 = load ptr, ptr %access9, align 8
  call void @_RcBox_add_weak_count(ptr %getmembervalue10)
  br label %if.end11

if.else:                                          ; preds = %if.cond.03
  %self12 = load ptr, ptr %self1, align 8
  %access13 = getelementptr inbounds nuw %Rc, ptr %self12, i32 0, i32 0
  %getmembervalue14 = load ptr, ptr %access13, align 8
  call void @_RcBox_add_strong_count(ptr %getmembervalue14)
  br label %if.end11

if.end11:                                         ; preds = %if.else, %if.then.04
  %self15 = load ptr, ptr %self1, align 8
  %deref = load %Rc, ptr %self15, align 8
  ret %Rc %deref
}
...
define %Rc @Rc_downgrade(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %ret_val = alloca %Rc, align 8
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %self2, i32 0, i32 0
  %getmembervalue = load ptr, ptr %access, align 8
  call void @_RcBox_add_weak_count(ptr %getmembervalue)
  %self3 = load ptr, ptr %self1, align 8
  %deref = load %Rc, ptr %self3, align 8
  %weak = alloca %Rc, align 8
  store %Rc %deref, ptr %weak, align 8
  %weak4 = load %Rc, ptr %weak, align 8
  %access5 = getelementptr inbounds nuw %Rc, ptr %weak, i32 0, i32 1
  %getmembervalue6 = load i1, ptr %access5, align 1
  store i1 true, ptr %access5, align 1
  %weak7 = load %Rc, ptr %weak, align 8
  ret %Rc %weak7
}

define %Rc @Rc_upgrade(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %ret_val = alloca %Rc, align 8
...
if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_33, ptr @str_32)
  call void @llvm.trap()
  unreachable
  br label %if.end
...
if.end:                                           ; preds = %if.then.0, %if.cond.0
  ...
  store %Rc %deref, ptr %ret, align 8
  br label %if.cond.04

if.cond.04:                                       ; preds = %if.end
  %self6 = load ptr, ptr %self1, align 8
  %access7 = getelementptr inbounds nuw %Rc, ptr %self6, i32 0, i32 1
  %getmembervalue8 = load i1, ptr %access7, align 1
  br i1 %getmembervalue8, label %if.then.05, label %if.else

if.then.05:                                       ; preds = %if.cond.04
  br label %if.cond.09

if.else:                                          ; preds = %if.cond.04
  %printf25 = call i32 (ptr, ...) @printf(ptr @println_fmt_37, ptr @str_36)
  br label %if.end24

if.cond.09:                                       ; preds = %if.then.05
  %self11 = load ptr, ptr %self1, align 8
  %access12 = getelementptr inbounds nuw %Rc, ptr %self11, i32 0, i32 0
  %getmembervalue13 = load ptr, ptr %access12, align 8
  %access14 = getelementptr inbounds nuw %_RcBox, ptr %getmembervalue13, i32 0, i32 1
  %getmembervalue15 = load i64, ptr %access14, align 8
  %sle = icmp sle i64 %getmembervalue15, 0
  br i1 %sle, label %if.then.010, label %if.end16

if.then.010:                                      ; preds = %if.cond.09
  %printf17 = call i32 (ptr, ...) @printf(ptr @println_fmt_35, ptr @str_34)
  call void @llvm.trap()
  unreachable
  br label %if.end16

if.end16:                                         ; preds = %if.then.010, %if.cond.09
  %self18 = load ptr, ptr %self1, align 8
  %access19 = getelementptr inbounds nuw %Rc, ptr %self18, i32 0, i32 0
  %getmembervalue20 = load ptr, ptr %access19, align 8
  call void @_RcBox_add_strong_count(ptr %getmembervalue20)
  %ret21 = load %Rc, ptr %ret, align 8
  %access22 = getelementptr inbounds nuw %Rc, ptr %ret, i32 0, i32 1
  %getmembervalue23 = load i1, ptr %access22, align 1
  store i1 false, ptr %access22, align 1
  br label %if.end24

if.end24:                                         ; preds = %if.else, %if.end16
  %ret26 = load %Rc, ptr %ret, align 8
  ret %Rc %ret26
}

define void @Rc_del(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  br label %if.cond.0
...
if.cond.0:                                        ; preds = %entry
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %self2, i32 0, i32 1
  %getmembervalue = load i1, ptr %access, align 1
  br i1 %getmembervalue, label %if.then.0, label %if.else

if.then.0:                                        ; preds = %if.cond.0
  %self3 = load ptr, ptr %self1, align 8
  %access4 = getelementptr inbounds nuw %Rc, ptr %self3, i32 0, i32 0
  %getmembervalue5 = load ptr, ptr %access4, align 8
  call void @_RcBox_sub_weak_count(ptr %getmembervalue5)
  br label %if.end

if.else:                                          ; preds = %if.cond.0
  %self6 = load ptr, ptr %self1, align 8
  %access7 = getelementptr inbounds nuw %Rc, ptr %self6, i32 0, i32 0
  %getmembervalue8 = load ptr, ptr %access7, align 8
  call void @_RcBox_sub_strong_count(ptr %getmembervalue8)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then.0
  %self9 = load ptr, ptr %self1, align 8
  %access10 = getelementptr inbounds nuw %Rc, ptr %self9, i32 0, i32 2
  %getmembervalue11 = load i1, ptr %access10, align 1
  store i1 true, ptr %access10, align 1
  ret void
}

define ptr @Rc_open(%Rc %self) {
entry:
  %self1 = alloca %Rc, align 8
  store %Rc %self, ptr %self1, align 8
  %ret_val = alloca ptr, align 8
...
if.cond.0:                                        ; preds = %entry
  %self2 = load %Rc, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Rc, ptr %self1, i32 0, i32 2
  %getmembervalue = load i1, ptr %access, align 1
  %self3 = load %Rc, ptr %self1, align 8
  %calltmp = call i64 @Rc_strong_count(%Rc %self3)
  %sle = icmp sle i64 %calltmp, 0
  %or = or i1 %getmembervalue, %sle
  br i1 %or, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_39, ptr @str_38)
  call void @llvm.trap()
  unreachable
  br label %if.end

if.end:                                           ; preds = %if.then.0, %if.cond.0
  %self4 = load %Rc, ptr %self1, align 8
  %access5 = getelementptr inbounds nuw %Rc, ptr %self1, i32 0, i32 0
  %getmembervalue6 = load ptr, ptr %access5, align 8
  %access7 = getelementptr inbounds nuw %_RcBox, ptr %getmembervalue6, i32 0, i32 0
  %getmembervalue8 = load ptr, ptr %access7, align 8
  ret ptr %getmembervalue8
}

define %Box @Box_new(i64 %type_size, ptr %data) {
entry:
  %type_size1 = alloca i64, align 8
  store i64 %type_size, ptr %type_size1, align 8
  %data2 = alloca ptr, align 8
  ...
  %getmembervalue = load ptr, ptr %access, align 8
  store ptr %new_data7, ptr %access, align 8
  %box9 = load %Box, ptr %box, align 8
  %access10 = getelementptr inbounds nuw %Box, ptr %box, i32 0, i32 1
  %getmembervalue11 = load i1, ptr %access10, align 1
  store i1 true, ptr %access10, align 1
  %box12 = load %Box, ptr %box, align 8
  ret %Box %box12
}

define ptr @Box_open(%Box %self) {
entry:
  %self1 = alloca %Box, align 8
  store %Box %self, ptr %self1, align 8
  %ret_val = alloca ptr, align 8
  br label %if.cond.0

if.cond.0:                                        ; preds = %entry
  %self2 = load %Box, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Box, ptr %self1, i32 0, i32 1
  %getmembervalue = load i1, ptr %access, align 1
  %not_tmp = xor i1 %getmembervalue, true
  br i1 %not_tmp, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_41, ptr @str_40)
  call void @llvm.trap()
  unreachable
  br label %if.end

if.end:                                           ; preds = %if.then.0, %if.cond.0
  %self3 = load %Box, ptr %self1, align 8
  %access4 = getelementptr inbounds nuw %Box, ptr %self1, i32 0, i32 0
  %getmembervalue5 = load ptr, ptr %access4, align 8
  ret ptr %getmembervalue5
}

define void @Box_free(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  br label %if.cond.0
...
if.cond.0:                                        ; preds = %entry
  %self2 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Box, ptr %self2, i32 0, i32 1
  %getmembervalue = load i1, ptr %access, align 1
  %not_tmp = xor i1 %getmembervalue, true
  br i1 %not_tmp, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_43, ptr @str_42)
  call void @llvm.trap()
  unreachable
  br label %if.end
...
if.end:                                           ; preds = %if.then.0, %if.cond.0
  %self3 = load ptr, ptr %self1, align 8
  %access4 = getelementptr inbounds nuw %Box, ptr %self3, i32 0, i32 0
  %getmembervalue5 = load ptr, ptr %access4, align 8
  call void @free(ptr %getmembervalue5)
  %self6 = load ptr, ptr %self1, align 8
  %access7 = getelementptr inbounds nuw %Box, ptr %self6, i32 0, i32 1
  %getmembervalue8 = load i1, ptr %access7, align 1
  store i1 false, ptr %access7, align 1
  ret void
}

define %Box @Box_move(ptr %self) {
entry:
  %self1 = alloca ptr, align 8
  store ptr %self, ptr %self1, align 8
  %ret_val = alloca %Box, align 8
  %self2 = load ptr, ptr %self1, align 8
  %deref = load %Box, ptr %self2, align 8
  %box = alloca %Box, align 8
  store %Box %deref, ptr %box, align 8
  br label %if.cond.0

if.cond.0:                                        ; preds = %entry
  %self3 = load ptr, ptr %self1, align 8
  %access = getelementptr inbounds nuw %Box, ptr %self3, i32 0, i32 1
  %getmembervalue = load i1, ptr %access, align 1
  %not_tmp = xor i1 %getmembervalue, true
  br i1 %not_tmp, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_45, ptr @str_44)
  call void @llvm.trap()
  unreachable
  br label %if.end
...
if.end:                                           ; preds = %if.then.0, %if.cond.0
  %self4 = load ptr, ptr %self1, align 8
  %access5 = getelementptr inbounds nuw %Box, ptr %self4, i32 0, i32 1
  %getmembervalue6 = load i1, ptr %access5, align 1
  store i1 false, ptr %access5, align 1
  %box7 = load %Box, ptr %box, align 8
  ret %Box %box7
}
...
entry:
  ...
  store i64 %getmembervalue, ptr %before, align 8
...
break-read:                                       ; preds = %if.then.019, %continue-read
  ...
  %getmembervalue32 = load i64, ptr %access31, align 8
  %before33 = load i64, ptr %before, align 8
  %sub34 = sub i64 %getmembervalue32, %before33
  %add_len35 = load ptr, ptr %add_len2, align 8
  store i64 %sub34, ptr %add_len35, align 8
...
if.then.0:                                        ; preds = %if.cond.0
  %calltmp8 = call %Result @Err(ptr @str_46)
  ret %Result %calltmp8
...
if.then.1:                                        ; preds = %if.cond.1
  ...
  store i64 0, ptr %add_len10, align 8
...
if.cond.018:                                      ; preds = %if.end
  ...
  %deref21 = load %String, ptr %buf20, align 8
...
define void @panic(ptr %msg) {
entry:
  %msg1 = alloca ptr, align 8
  store ptr %msg, ptr %msg1, align 8
  %msg2 = load ptr, ptr %msg1, align 8
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_47, ptr %msg2)
  call void @llvm.trap()
  unreachable
  ret void
}
...
if.cond.0:                                        ; preds = %entry
  %cond3 = load i1, ptr %cond1, align 1
  %not_tmp = xor i1 %cond3, true
  br i1 %not_tmp, label %if.then.0, label %if.end

if.then.0:                                        ; preds = %if.cond.0
  %msg4 = load ptr, ptr %msg2, align 8
  call void @panic(ptr %msg4)
  br label %if.end
...
entry:
  ...
  %scanf = call i32 (ptr, ...) @scanf(ptr @str_48, ptr %n)
  %n1 = load i64, ptr %n, align 8
  %calltmp2 = call ptr @input_i64(i64 %n1)
  %a = alloca ptr, align 8
  store ptr %calltmp2, ptr %a, align 8
  %ans3 = load i64, ptr %ans, align 8
  %fmt_buf = alloca [128 x i8], align 1
  %sprintf = call i32 (ptr, ptr, ...) @sprintf(ptr %fmt_buf, ptr @str_49, i64 %ans3)
  %printf = call i32 (ptr, ...) @printf(ptr @println_fmt_50, ptr %fmt_buf)
